...
ทุกบรรทัดของทุกชุดทดสอบควรจบด้วย `PASS`
...
| ถ้าคุณต้องการ | อ่าน |
| --- | --- |
| สถาปัตยกรรม หลักการออกแบบ และคู่มือเริ่มต้นฉบับวิศวกร | [Engineering guide](docs/engineering.md) |
| ตัวแปรสภาพแวดล้อมทุกตัว ข้อตกลงไฟล์ และกฎ exit code ทั้งหมด | [Reference](docs/reference.md) |
