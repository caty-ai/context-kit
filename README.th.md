...
- 📋 **brief-validator**
  ...
  บล็อกการมอบหมายงานยาวๆ ให้ซับเอเจนต์ เว้นแต่จะมีบรีฟ 3 ส่วนแนบมาด้วย คือ จะสร้างอะไร ผู้ทำงานเช็คตัวเองอย่างไร และผู้รีวิวตัดสินอย่างไร หัวข้อย่อยเริ่มต้นใช้ได้ทั้งหัวข้อภาษาญี่ปุ่นจาก public handbook ซึ่งเป็นต้นทางของสัญญานี้ หรือหัวข้อภาษาอังกฤษที่เทียบเท่ากัน และยังสลับได้ด้วยตัวแปรสภาพแวดล้อมตัวเดียว
