...
- 📋 **brief-validator**
  ...
  除非一次委托带齐三层说明——要做什么、执行者怎么自查、评审者依据什么判断——否则会拦下这次对子 agent 的长篇委托。默认的分节标题可以使用这份契约出处——那本公开 handbook——里的日语标题或对应的英语标题，并且仍可用一个环境变量整体替换。
...
[卸载说明见 npm README](https://github.com/caty-ai/context-kit/blob/main/packages/npm/README.md#uninstall)。
